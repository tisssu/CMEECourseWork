...
def getselectpair(cumsumrate):# Roulette
...
genermax = 100 #iteration number
ratecross = 0.70 #Chromosome mating rate
ratemutation = 0.12 #mutation
...
while genermax > 0:
    ...
    for i in range(0,sizepop,2):
        ...
        if rand2[0]<=ratecross:#cross operation1
        ...
        if rand2[1]<=ratecross:#cross operation2
