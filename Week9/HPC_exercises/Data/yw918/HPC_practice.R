...
cluster_run = function(speciation_rate,size,wall_time,interval_rich,interval_oct,burn_in_generations,output_file_name)
{
  ...
  # calculate species richness for burn-in process
...
#cluster_run(speciation_rate = 0.005579,size = size,wall_time = 11.5,interval_rich = 1,interval_oct = size/10, burn_in_generations = 8*size, output_file_name = paste("HPC_results",iter,".rda",sep = ""))
cluster_run(speciation_rate = 0.005579,size = size,wall_time = 11.5 * 60 * 60,interval_rich = 1,interval_oct = size/10,burn_in_generations = 8*size,output_file_name = paste("HPC_results",iter,".rda",sep = ""))
...
test_iter = function(iter)
{
  ...
  cluster_run(speciation_rate = 0.005579,size = size,wall_time = 11.5,interval_rich = 1,interval_oct = size/10,burn_in_generations = 8*size,output_file_name = paste("HPC_result_test",iter,".rda",sep = ""))
}
